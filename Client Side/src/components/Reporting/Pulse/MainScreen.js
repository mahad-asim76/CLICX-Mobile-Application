...
import { ScrollView,View, FlatList, Text, Modal, Image, TouchableWithoutFeedback,TouchableOpacity, TouchableHighlight} from 'react-native';
...
const MainScreen =  () => {
  ...
  const [DealerViewFilter, setDealerViewFilter] = useState([]);
  ...
  const fetchNotificationsData = async () => {
    try {
      const response = await serviceClient.getDataAsync(Constants.Reporting, Constants.AgentLogs, "")
  ...
  const autoRefreshNotificationData = () => {
    fetchNotificationsData();
    setTimeout(autoRefreshNotificationData, 100000);
  };

  const waitCallData = async () => {
    try {
      const response = await serviceClient.getDataAsync(Constants.Reporting, Constants.WaitCalls,"")
      const jsonData = JSON.parse(LZString.decompressFromBase64(response.value.data));
      setWaitData(jsonData)
    } catch (error) {
      setIsLoading(false);
    }
  };

  const autoRefreshWaitData = () => {
    waitCallData();
    setTimeout(autoRefreshWaitData, 5000);
  };
  ...
  const postRequest = async (requestData) => {
    ...
    try{
      ...
      setDealerViewFilter(json_data.DealerViewFilters)
  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.contentOverlay}>
        ...
        <View style={styles.tabContainer}>
          <TouchableOpacity
            style={[
              DealerViewFilter.isDealerView ? styles.DealertabStyle : styles.tabStyle,
          ...
          >
            <Text style={[styles.tabText, activeTab === Constants.PulseTab.HourlySkills && styles.activeTabText]}>{DealerViewFilter.isDealerView ? 'Hourly Performance' : 'Hourly Skills'}</Text>
          </TouchableOpacity>
        </View>
        {activeTab === Constants.PulseTab.Summary && (
          skillData.length > 0 ? (
            <>     
              {(showRowMainContainer && !DealerViewFilter.isDealerView) && (
                <>
                  ...
                  <ScrollView horizontal={true} 
                    ...
                    <View style={styles.rowContainer}>
                      ...
                      >
                        ...
                        {agentInfoStats.TotalLogin.ToolTip && agentInfoStats.TotalLogin.ToolTip.Data !== null && agentInfoStats.TotalLogin.ToolTip.Data.length > 0 && (
                      ...
                      >
                        ...
                        {agentInfoStats.Busy.ToolTip && agentInfoStats.Busy.ToolTip.Data !== null && agentInfoStats.Busy.ToolTip.Data.length > 0 && (
                      ...
                      >
                        ...
                        {agentInfoStats.Wait.ToolTip && agentInfoStats.Wait.ToolTip.Data !== null && agentInfoStats.Wait.ToolTip.Data.length > 0 && (
                      ...
                      >
                        ...
                        {agentInfoStats.OnWrap.ToolTip && agentInfoStats.OnWrap.ToolTip.Data !== null && agentInfoStats.OnWrap.ToolTip.Data.length > 0 && (
                    ...
                    <View style={styles.rowContainer}>
                      ...
                      >
                        ...
                        {agentInfoStats.OnBreak.ToolTip && agentInfoStats.OnBreak.ToolTip.Data !== null && agentInfoStats.OnBreak.ToolTip.Data.length > 0 && (
                      ...
                      >
                        ...
                        {agentInfoStats.Training.ToolTip && agentInfoStats.Training.ToolTip.Data !== null && agentInfoStats.Training.ToolTip.Data.length > 0 && (
                      ...
                      >
                        ...
                        {agentInfoStats.Coaching.ToolTip && agentInfoStats.Coaching.ToolTip.Data !== null &&  agentInfoStats.Coaching.ToolTip.Data.length > 0 && (
                      ...
                      <View style={styles.NotMainContainer}>
                        <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Initiated.PopUpData && summaryCallsStats.Initiated.PopUpData.Data !== null && summaryCallsStats.Initiated.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Answer.PopUpData && summaryCallsStats.Answer.PopUpData.Data !== null && summaryCallsStats.Answer.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Abandon.AbandonsDuration && summaryCallsStats.Abandon.AbandonsDuration.Data !== null && summaryCallsStats.Abandon.AbandonsDuration.Data.length > 0 && (
                        ...
                        <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>  
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Short_Abandons.PopUpData && summaryCallsStats.Short_Abandons.PopUpData.Data !== null && summaryCallsStats.Short_Abandons.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.IVRHangups.PopUpData && summaryCallsStats.IVRHangups.PopUpData.Data !== null && summaryCallsStats.IVRHangups.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Fatal_Calls.PopUpData && summaryCallsStats.Fatal_Calls.PopUpData.Data !== null && summaryCallsStats.Fatal_Calls.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                            ...
                            {summaryCallsStats.Repeat_Call.PopUpData && summaryCallsStats.Repeat_Call.PopUpData.Data !== null && summaryCallsStats.Repeat_Call.PopUpData.Data.length > 0 && (
                  ...
                  >
                    <View style={styles.NotMainContainer}>
                      ...
                      <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>  
                        ...
                        <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                          <View style={styles.LogoContainer}>
                              <Text style={showRowMainContainer ? styles.rowFirstLeftText : styles.rowFirstVerticalLeftText}>ASA</Text> 
                              {svgIcon.SvgASA({ width: styles.LogoIcon.width, height: styles.LogoIcon.height })}
                            </View>
                            <Text style={styles.rowDetailUpperText}>{summaryCallsStats.ASA}</Text>
                          </View>
                        <View style={showRowMainContainer ? styles.detailRow : styles.detailVerticalRow}>
                          <TouchableOpacity onPress={toggleRepeatModal} disabled={summaryCallsStats.Repeat_Call.Value <= 0}>
                            <View style={styles.LogoContainer}>
                      ...
                      <View style={styles.NotMainContainer}>
                        <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>
                          <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                            ...
                            {summarySalesStats.RGUInfo && summarySalesStats.SaleInfo!== null && summarySalesStats.SaleInfo.ProviderWiseDetail.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                            ...
                            {summarySalesStats.Utility_RGU.PopUpData && summarySalesStats.Utility_RGU.PopUpData.Data !== null && summarySalesStats.Utility_RGU.PopUpData.Data.length > 0 && (
                        ...
                        <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>   
                          ...
                          {summarySalesStats.Qualifications.PopUpData && summarySalesStats.Qualifications.PopUpData.Data !== null && summarySalesStats.Qualifications.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                            ...
                            {summarySalesStats.Addons.PopUpData && summarySalesStats.Addons.PopUpData.Data !== null && summarySalesStats.Addons.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                            ...
                            {summarySalesStats.Optins.PopUpData && summarySalesStats.Optins.PopUpData.Data !== null && summarySalesStats.Optins.PopUpData.Data.length > 0 && (
                          ...
                          <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                            ...
                            {summaryCallsStats.Outbound_RGUs.PopUpData && summaryCallsStats.Outbound_RGUs.PopUpData.Data !== null && summaryCallsStats.Outbound_RGUs.PopUpData.Data.length > 0 && (
                  ...
                  <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} 
                    ...
                    <View style={styles.NotMainContainer}>
                      ...
                      <View style={showRowMainContainer?styles.rowContainer: styles.rowVerticalContainer}>   
                        ...
                        <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                          <View style={styles.LogoContainer}>
                            <Text style={showRowMainContainer ? styles.rowFirstLeftText : styles.rowFirstVerticalLeftText}>Conversion Rate</Text>
                            {svgIcon.SvgConversionRate({ width: styles.LogoIcon.width, height: styles.LogoIcon.height })}
                          </View>
                          <Text style={styles.rowFirstRightText}>{summaryCallsStats.Sales_per_Qualifications}</Text>
                        </View>
                        <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                          <View style={styles.LogoContainer}>
                            <Text style={showRowMainContainer ? styles.rowFirstLeftText : styles.rowFirstVerticalLeftText}>Orders</Text>
                            {svgIcon.SvgOrders({ width: styles.LogoIcon.width, height: styles.LogoIcon.height })}
                          </View>
                          <Text style={styles.rowFirstRightText}>{summaryCallsStats.Orders}</Text>
                        </View>
                        <View style={showRowMainContainer ? styles.detailFirstRow : styles.detailFirstVerticalRow}>
                          <View style={styles.LogoContainer}>
                            <Text style={showRowMainContainer ? styles.rowFirstLeftText : styles.rowFirstVerticalLeftText}>RGU/Order</Text>
                            {svgIcon.SvgRGUOrder({ width: styles.LogoIcon.width, height: styles.LogoIcon.height })}
                          </View>
                          <Text style={styles.rowFirstRightText}>{summaryCallsStats.RGU_per_Sales}</Text>
                        </View>                           
                      </View>
                    </View>
                  </ScrollView>
    ...
    {skillData.length > 0 ?  DealerViewFilter.isDealerView == false ? (
      <View style={styles.footer}>
        ...
        {userFeature("PULSE Waiting Calls") && (
          <View style={styles.footerContainer}>
            <TouchableOpacity
                ...
                {waitData.length > 0 ? ( 
                  <View style={styles.notification}>
                    <View style={styles.notificationNumberStyle}>
                      <Text style={styles.notificationTitle}>{waitData.length}</Text>
                    </View>
                  </View>
                ):''} 
            </TouchableOpacity>
