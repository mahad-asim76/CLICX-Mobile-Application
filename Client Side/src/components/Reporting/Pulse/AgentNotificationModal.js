...
const AgentNotificationModal = ({ isVisible, closeModal, data, updateTime }) => {
  ...
  const renderItem = ({ item }) => (
    <View
      ...
      <Text style={[styles.agentTextTitle, {color: item.Status === Constants.AgentStatus.Login ? styles.defaultLoginColor.color:styles.defaultLogoutColor.color}]}> {item.AgentName != '' ? item.AgentName : 'Test Name'}</Text></Text>
      ...
      <Text style={[styles.agentTextTitle, {color: item.Status === Constants.AgentStatus.Login? styles.defaultLoginColor.color:styles.defaultLogoutColor.color}]}> {item.LOCATION != '' ? item.LOCATION : 'Test Location'}</Text></Text>
