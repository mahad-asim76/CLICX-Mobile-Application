...
const AppNavigation = () => {
  ...
  const [routeName, setRouteName] = useState(Constants.LoginScreen);
        ...
        try {     
          if(await ClicxMethods.userToken() == null){
            ...
            if(ResponseData.status == 500){
              Alert.alert('', 'Server not Responding!', [{ text: 'OK' }], { cancelable: false });
            }
            else {
                    ...
                    [
                      {
                        ...
                        onPress: async () => {
                          ...
                          if (ResponseData.valid) {
                            setRouteName(Constants.LoginScreen);
                            setQuitConfirmed(true);
                            setHasNavigated(false);
                          }
                        },
